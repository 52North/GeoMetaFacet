...
Exhibit.TabularView._settingSpecs = {
    ...
    "cellPadding":          { type: "int",     defaultValue: 1 },
...
//CH
Exhibit.TabularView.prototype._getSortedItems = function(items, asc) {
	var multiply = asc ? 1 : -1;
	//var multiply = asc ? -1 : 1;
	 
	items.sort(function(a, b) {     
		return multiply * a.label.toString().localeCompare(b.label.toString());
	});
