...
Exhibit.OLMapView._settingSpecs = {
    ...
    "color":            { type: "text",     defaultValue: "#F9B200" }, //"#FF9000" },
    ...
    "opacity":          { type: "float",    defaultValue: 1			}, //0.7       },
...
Exhibit.OLMapView.prototype._constructMap = function(mapDiv) {
    ...
    if (settings.mapConstructor != null) { 
    	console.log("in olmap-view.js get constructor");
		...
		"displayProjection": this._projection,
	        ...
	        "maxExtent": new OpenLayers.Bounds(-181, -91, 181, 91)
        });
	...
	//neu CH
	var availableLayers = [wms];
	var availability = { "wms" : wms };
	//end neu CH
