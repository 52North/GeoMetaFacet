...
(function() {
    ...
    loader = function() {
        ...
        OpenLayersFiles = [ 
            "js/OpenLayers-2.12/OpenLayers.js"
        ];
        cssFiles = [
            "map-view.css"];
        paramTypes = {
        ...
        cssURLs = [];
        /*
        if (Exhibit.MapExtension.params.service === "google2" && typeof GMap2 === "undefined") {
            ...
            javascriptFiles.push("/js/OpenLayers-2.12/OpenLayers.js");
            ...
            if (typeof google === "undefined" || (typeof google !== "undefined" && typeof google.map === "undefined")) {
        ...
        */
        ...
        Exhibit.includeJavascriptFiles(null, OpenLayersFiles);

        finishedLoadingOpenLayers = function(){
            if (typeof OpenLayers != undefined){
                console.log("OpenLayers Type found");
                Exhibit.jQuery(document).trigger("delayFinished.exhibit", delayID);
            }else{
                console.log("OpenLayers undefined");
            }
        }

        finishedLoadingOpenLayers();
        /*
        finishedLoading = function() {
            if ((typeof google === "undefined" || (typeof google !== "undefined" && typeof google.maps === "undefined")) && typeof GMap2 === "undefined") {
