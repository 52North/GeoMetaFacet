...
(function(w){
    ...
    var store = function store(hmap){
        ...
        var _ = {
            ...
            T4M_heatmap: document.getElementById("T4M_heatmapArea"),
            MAP_heatmap: document.getElementById("MAP_heatmapArea"),
            MVI_heatmap: document.getElementById("MVI_heatmapArea"),
            INF_heatmap: document.getElementById("INF_heatmapArea"),
    ...
    store.prototype = {
        ...
        addDataPoint: function(x, y, mode){
            if(x < 0 || y < 0)
                return;
            ...
            var me = this,
             ...
             if (mode == "MAP")   
                data = me.get("MAP_data");
             else if (mode == "T4M")   
                 data = me.get("T4M_data");
             else if (mode == "INF")   
                 data = me.get("INF_data");
             else if (mode == "MVI")   
                 data = me.get("MVI_data");
            ...
            data[x][y]+=1;//(arguments.length<3)?1:arguments[2];
            
            //CH
            //me.set("data", data);
            
            if (mode == "MAP")   
                me.set("MAP_data", data);
             else if (mode == "T4M")   
            	 me.set("T4M_data", data);
             else if (mode == "INF")   
            	 me.set("INF_data", data);
             else if (mode == "MVI")   
            	 me.set("MVI_data", data);
            //CH
        ...
        setDataSet: function(obj, internal, config, mode){
            var me = this,
                heatmap = me.get("heatmap"),
                data = [],
                d = obj.data,
