            ...
            click: new OpenLayers.Control.WMSGetFeatureInfo({
                ...
                eventListeners: {
                    beforegetfeatureinfo: function(event) {
                        ...
                        dojo.byId("featureInfo_frame").src = "featureInfo.jsp?url=" + service_url + "?" + "request=GetFeatureInfo&service=WMS" + "&version=" + service_version

                        + "&query_layers=" + layer_Array[vis_layer_number].params.LAYERS
                        //+ "&query_layers=" + layer_Array[vis_layer_number].name
                        + "&crs=" + service_srs + "&bbox=" + map.getExtent().toBBOX() + "&width=800&height=470" + "&I=" + event.xy.x + "&J=" + event.xy.y + "&time=" + cutDate(dijit.byId('time_slider').get('value'));
                        //SH
                        //					$.ajax({
            ...
            click: new OpenLayers.Control.WMSGetFeatureInfo({
                ...
                eventListeners: {
                    beforegetfeatureinfo: function(event) {
                        ...
                        + "&crs=" + service_srs + "&bbox=" + map.getExtent().toBBOX() + "&width=800&height=470" + "&I=" + event.xy.x + "&J=" + event.xy.y + "&time=" + dijit.byId('stateSelect').get('value');
                        //SH
                        //					$.ajax({
                        //						"url" : 'FeatureInfoRequester',
                        //						"type" : 'GET',
            ...
            click: new OpenLayers.Control.WMSGetFeatureInfo({
                ...
                eventListeners: {
                    beforegetfeatureinfo: function(event) {
                        ...
                        + "&crs=" + service_srs + "&bbox=" + map.getExtent().toBBOX() + "&width=800&height=470" + "&I=" + event.xy.x + "&J=" + event.xy.y + "&info_format=text/xml" + "&time=x";
                        //SH
                        //					$.ajax({
                        //						"url" : 'FeatureInfoRequester',
                        //						"type" : 'GET',
